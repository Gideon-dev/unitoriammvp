...
const TutorialCard: React.FC<TutorialCardProps> = ({
  ...
  return (
    <div className="flex flex-col justify-between items-center w-full relative h-[212px] overflow-hidden rounded-[15px] border">
      <div className="w-full h-[60%] max-h-full" style={{backgroundImage: `url('https://res.cloudinary.com/dtlz2vhof/${image}')`, backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat"}} />
